/*
* ImagiNet Compiler 5.6.3663.65534+5b2aab8685ffc79f3c7e3884012f3f592bebe167
* Copyright © 2023- Imagimob AB, All Rights Reserved.
* 
* Generated at 11/13/2025 06:17:12 UTC. Any changes will be lost.
* 
* Model ID  f8cfcb78-d174-4cc9-9747-95f035a45c2a
* 
* Memory    Size                      Efficiency
* Buffers   16000 bytes (RAM)         100 %
* State     347152 bytes (RAM)        100 %
* Readonly  815648 bytes (Flash)      100 %
* 
* Exported functions:
* 
*  @param data_in Input features. Input float[16000,1].
*  @param data_out Output features. Output float[1].
...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x78, 0xcb, 0xcf, 0xf8, 0x74, 0xd1, 0xc9, 0x4c, 0x97, 0x47, 0x95, 0xf0, 0x35, 0xa4, 0x5c, 0x2a}
...
// data_in [16000,1] (64000 bytes)
#define IMAI_DATA_IN_RANK (2)
#define IMAI_DATA_IN_SHAPE (((int[]){1, 16000})
#define IMAI_DATA_IN_COUNT (16000)
...
#define IMAI_DATA_OUT_SHAPE (((int[]){1})
#define IMAI_DATA_OUT_COUNT (1)
...
// Profiling regions
    ...
    #define IMAI_REGIONS_NAMES {\
    	"HACHIMITSU_DETECTOR_INT8-NO_MEL_INT8X8",\
    }
    typedef enum {
    	IMAI_HACHIMITSU_DETECTOR_INT8_NO_MEL_INT8X8 = 0,
    } IMAI_Region_t;
#else
