...
#define STEP_SIZE_SEC           0.192f          // 姝ラ暱
#define OUTPUT_THRESHOLD_SCORE  0.6f            // 鐚彨闃堝€?
#define WINDOW_SIZE             0.832f          // 绐楀彛澶у皬
...
#define WINDOW_SIZE_SAMPLES     ((int)(SAMPLE_RATE * WINDOW_SIZE + 0.5))     // 鍔?.5鍚戜笅鍙栨暣闃叉绮惧害涓㈠け
#define STEP_SIZE_SAMPLES       ((int)(SAMPLE_RATE * STEP_SIZE_SEC + 0.5))   // 鍔?.5鍚戜笅鍙栨暣闃叉绮惧害涓㈠け
