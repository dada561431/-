...
#define DISPLAY_I2C_CONTROLLER_CLK_DIV_GRP_NUM CYBSP_I2C_DISPLAY_CONTROLLER_CLK_DIV_GRP_NUM
#define DISPLAY_I2C_CONTROLLER_CLK_DIV_HW      CYBSP_I2C_DISPLAY_CONTROLLER_CLK_DIV_HW
#define DISPLAY_I2C_CONTROLLER_CLK_DIV_NUM     CYBSP_I2C_DISPLAY_CONTROLLER_CLK_DIV_NUM
#else
...
#define DISPLAY_I2C_CONTROLLER_CLK_DIV_GRP_NUM CYBSP_I2C_CONTROLLER_CLK_DIV_GRP_NUM
#define DISPLAY_I2C_CONTROLLER_CLK_DIV_HW      CYBSP_I2C_CONTROLLER_CLK_DIV_HW
#define DISPLAY_I2C_CONTROLLER_CLK_DIV_NUM     CYBSP_I2C_CONTROLLER_CLK_DIV_NUM
#endif
